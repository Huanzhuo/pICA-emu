...
if __name__ == '__main__':
    ...
    service_latency_compute_forward = np.loadtxt(path_time_compute_client, delimiter=',', dtype=None, usecols=[0])
    service_latency_store_forward = np.loadtxt(path_time_store_client, delimiter=',', dtype=None, usecols=[0])
